            ...
            <div class="dialog">
                <table>
                    <tbody>
                      ...
                      <!--  <tr class="prop">
                            <td valign="top" class="name"><g:message code="categoria.usuario.label" default="Usuario" /></td>
                            
                            <td valign="top" class="value"><g:link controller="usuario" action="show" id="${categoriaInstance?.usuario?.id}">${categoriaInstance?.usuario?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="categoria.pendientes.label" default="Pendientes" /></td>
