    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="registrar" >
                    ...
                    <table>
                        <tbody>
                           ...
                           <!-- <tr class="prop">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="activo"><g:message code="usuario.codigo.label" default="Introduce Codigo" /></label>
                                </td>
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="create" class="save" value="Registrar" /></span>
                </div>
            </g:form>
        </div>
    </body>
